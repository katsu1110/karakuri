...
Sincerely,
Katsuhisa / contact@karakuri.example.com / https://karakuri.vercel.app
```
...
2. note.com のエディタに貼り付け、文末に以下の導線を追加する:
   ...
   > 👉 [KARAKURI で全編を読む](https://karakuri.vercel.app/article.html?slug=<slug>)
