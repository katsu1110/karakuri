...
Sincerely,
Katsuhisa / contact@kokoro-lab.example.com / https://kokoro-lab.vercel.app
```
...
`kokoro-lab` に深掘り記事を公開した際、SEOの重複コンテンツ扱いを避けつつ note.com から集客するための手順:

### 投稿手順
1. `content/articles/<slug>.md` から**冒頭〜結論の手前まで**をコピーする。
2. note.com のエディタに貼り付け、文末に以下の導線を追加する:
   > 続きを読む（全文・参考文献・詳細解説は本家サイトで公開中）:  
   > 👉 [kokoro-lab で全編を読む](https://kokoro-lab.vercel.app/article.html?slug=<slug>)
